...
<div class="container">
	<div class="row vh-100">
		<div class="col-sm-6 col-lg-3 my-auto">
			<div class="box shadow-sm p-4">
				<div class="image-wrapper mb-3">
					<img class="img-fluid" src="assets/img/partners/anisha.jpeg" alt="..." />
				</div>
				<div class="box-desc">
		...
		<div class="col-sm-6 col-lg-3 my-auto">
			<div class="box shadow-sm p-4">
				<div class="image-wrapper mb-3">
					<img class="img-fluid" src="assets/img/partners/shubhangi.jpeg" alt="..." />
				</div>
				<div class="box-desc">
		...
		<div class="col-sm-6 col-lg-3 my-auto">
			<div class="box shadow-sm p-4">
				<div class="image-wrapper mb-3">
					<img class="img-fluid" src="assets/img/partners/avni_shah.jpeg" alt="..." />
				</div>
				<div class="box-desc">
					<h5>Avni Shah</h5>
					<p>Ex Partner</p>
